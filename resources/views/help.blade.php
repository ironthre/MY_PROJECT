...
<div class="container bg mt-2">
    <nav aria-label="breadcrumb font-weight-bolder">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active font-weight-bolder" aria-current="page">Help</li>
        </ol>
    </nav>
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card my-5 border-0">
                <div class="card-header" style="font-weight: bold"><h4>Help Center</h4></div>
